 ...
 ***************************************************************************/
namespace  Magebees\Mostviewed\Block\Adminhtml\Product\Edit\Tab;
...
class Productinfo extends Extended
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                        'header' => __('Name'),
                        'index' => 'name',
                        'header_css_class' => 'col-name name',
                        'column_css_class' => 'col-name name'
                ]
        );
        $this->addColumn(
            'type',
            [
                        ...
                        'header_css_class' => 'col-type type',
                        'column_css_class' => 'col-type type'
                ]
        );
        ...
        $this->addColumn(
            ...
            [
                        ...
                        'header_css_class' => 'col-status status',
                        'column_css_class' => 'col-status status'
                ]
        );
        ...
        $this->addColumn(
            ...
            [
                        ...
                        'header_css_class' => 'col-visibility visibility',
                        'column_css_class' => 'col-visibility visibility'
                ]
        );
        ...
        $this->addColumn(
            ...
            [
                        'header' => __('SKU'),
                        'index' => 'sku',
                        'header_css_class' => 'col-sku sku',
                        'column_css_class' => 'col-sku sku'
                ]
        );
    ...
    {
        $products = $this->getProductsMostviewed();
