...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $entityIds=$jsHelper->decodeGridSerializedInput($data['links']['mostviewed']);
        if (!is_array($entityIds) || empty($entityIds)) {
            ...
            $customcollection= $this->_objectManager->get('Magebees\Mostviewed\Model\Customcollection')->getCollection()->getData();
                        ...
                        foreach ($all_store as $store) {
                            ...
                            foreach ($customcollection as $custom) {
                                if ($custom['store_id']==$store_id) {
                                    ...
                                    $data=$this->_objectManager->create('Magebees\Mostviewed\Model\Customcollection');
